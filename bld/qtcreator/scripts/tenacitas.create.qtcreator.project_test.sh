...
echo "  tester::test _test(argc, argv); "                    >> "$tst_main_file"
echo "  run_test(_test, $tst_name); "                        >> "$tst_main_file"
echo "}"                                                     >> "$tst_main_file"
echo ""                                                      >> "$tst_main_file"
...
echo ""                                                           >> "$tst_build_file"
echo "LIBS+=\$\$libs_dir/libtenacitas.tester.\$\$static_lib_ext"  >> "$tst_build_file"
