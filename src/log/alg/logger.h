...
#include <tenacitas.lib/src/log/alg/internal/file.h>
#include <tenacitas.lib/src/log/alg/internal/wrapper.h>
#include <tenacitas.lib/src/log/typ/level.h>
...
/// \brief Wrapper to the test log function
#define TNCT_LOG_TST(p_params...)                                              \
  { tenacitas::lib::src::log::alg::dummy(std::cout, p_params); }
