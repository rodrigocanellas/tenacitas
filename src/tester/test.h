...
#ifndef TENACITAS_SRC_TESTER_TEST_H
#define TENACITAS_SRC_TESTER_TEST_H
...
/// \brief Runs a test
///
/// \param test is an instance of tenacitas::src::test defined
/// below
///
/// \param test is the name of a class that implements
///
/// \code
/// bool operator()(const tenacitas::src::program::options &)
///
...
namespace tenacitas::src::tester {
/// \brief The test struct executes tests implemented in classes
///
/// \tparam use makes tenacitas::src::tester to be compiled only if
/// actually used
///
/// \code
/// #include <iostream>
