...
/// \brief Wraps to the debug log function
#define concurrent_debug(p_log, p_params...)

/// \brief Wraps to the info log function
#define concurrent_info(p_log, p_params...)

/// \brief Wraps to the warn log function
#define concurrent_warn(p_log, p_params...)

/// \brief Wraps to the error log function
#define concurrent_error(p_log, p_params...)

/// \brief Wraps to the fatal log function
#define concurrent_fatal(p_log, p_params...)

#endif

#endif // TENACITAS_CONCURRENT_CONCURRENT_LOG_H
