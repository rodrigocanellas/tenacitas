...
#ifndef TENACITAS_SRC_SRC_ASYNC_DISPATCHER_H
#define TENACITAS_SRC_SRC_ASYNC_DISPATCHER_H
...
template <src::traits::log::logger t_logger, traits::async::event... t_events>
...
public:
  ...
  result add_handling(handling_id &&p_id, t_handler &&p_handler,
