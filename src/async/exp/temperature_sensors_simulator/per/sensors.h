...
#ifndef TENACITAS_SRC_ASYNC_EXP_TEMPERATURE_SENSORS_SIMULATOR_PER_SENSORS_H
#define TENACITAS_SRC_ASYNC_EXP_TEMPERATURE_SENSORS_SIMULATOR_PER_SENSORS_H
...
#include "tenacitas/src/async/exp/temperature_sensors_simulator/per/sensor.h"
...
private:
  ...
  src::async::result define_set_temperature_handling()
  {
    ...
    static_assert(
        src::async::traits::has_add_handling_method<
