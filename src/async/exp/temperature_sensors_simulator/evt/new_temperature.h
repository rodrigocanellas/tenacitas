#ifndef TENACITAS_SRC_ASYNC_EXP_TEMPERATURE_SENSORS_SIMULATOR_EVT_NEW_TEMPERATURE_H
#define TENACITAS_SRC_ASYNC_EXP_TEMPERATURE_SENSORS_SIMULATOR_EVT_NEW_TEMPERATURE_H
