...
#ifndef TENACITAS_SRC_ASYNC_EXP_DISPATCHER_PUBLISHER_H
#define TENACITAS_SRC_ASYNC_EXP_DISPATCHER_PUBLISHER_H
...
struct publisher {
  ...
  publisher(t_dispacther &p_dispatcher, src::async::exp::logger &p_logger,
