...
#ifndef TENACITAS_SRC_ASYNC_EXP_DISPATCHER_HANDLER_H
#define TENACITAS_SRC_ASYNC_EXP_DISPATCHER_HANDLER_H
...
template <event_id t_event_id, handler_type_id t_type_id,
          src::async::traits::has_publish_method<src::async::exp::event_handled>
              t_dispatcher>
struct handler
{
  using event = src::async::exp::event<t_event_id>;
  ...
  static constexpr src::async::exp::handler_type_id type_id{t_type_id};
  static constexpr src::async::exp::event_id        event_id{t_event_id};
