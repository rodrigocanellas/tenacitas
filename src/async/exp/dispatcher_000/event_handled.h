...
#ifndef TENACITAS_SRC_ASYNC_EXP_DISPATCHER_EVENT_HANDLED_H
#define TENACITAS_SRC_ASYNC_EXP_DISPATCHER_EVENT_HANDLED_H
...
struct event_handled
{
  ...
  explicit event_handled(const src::async::handling_name &p_handling_id,
  ...
  src::async::handling_name        handling_id;
  src::async::exp::event_id        event_id{' '};
  src::async::exp::handler_type_id handler_type_id{
      std::numeric_limits<uint16_t>::max()};
  src::async::exp::handler_id handler_id;
};
