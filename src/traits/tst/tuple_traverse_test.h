...
#ifndef TENACITAS_SRC_TRAITS_TST_TUPLE_TRAVERSE_H
#define TENACITAS_SRC_TRAITS_TST_TUPLE_TRAVERSE_H
...
struct tuple_traverse_000 {
  ...
  bool operator()(const src::program::options &) {
    ...
    auto _ret{true};
    auto _visit =
        [&_ret]<src::tuple::traits::is_tuple t_tuple, std ::size_t t_idx>() {
    ...
    src::tuple::traits::traverse<my_tuple>(
