...
#ifndef TENACITAS_SRC_TRAITS_TUPLE_TRAVERSE_H
#define TENACITAS_SRC_TRAITS_TUPLE_TRAVERSE_H
...
template <traits::tuple::is_tuple t_tuple, typename t_func, std::size_t t_idx = 0>
