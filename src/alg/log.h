...
#ifndef TENACITAS_LIB_ALG_INTERNAL_LOG_H
#define TENACITAS_LIB_ALG_INTERNAL_LOG_H

#include <tenacitas.lib/src/alg/internal/log_file.h>
#include <tenacitas.lib/src/alg/internal/log_wrapper.h>
