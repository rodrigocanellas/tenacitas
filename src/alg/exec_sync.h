...
#ifndef TENACITAS_LIB_ALG_EXEC_ASYNC_H
#define TENACITAS_LIB_ALG_EXEC_ASYNC_H
...
/// if it must continue to exec_sync
///
...
inline std::conditional_t<
    ...
    std::optional<
        std::invoke_result_t<t_function, std::function<bool()>, t_params...>>>
exec_sync(tlc::convertible_to_nano auto p_max_time, t_function &p_function,
          t_params &&...p_params) {
  std::mutex _mutex;
