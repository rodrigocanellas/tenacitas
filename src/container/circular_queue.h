...
#ifndef TENACITAS_SRC_CONTAINER_CIRCULAR_QUEUE_H
#define TENACITAS_SRC_CONTAINER_CIRCULAR_QUEUE_H
...
namespace tenacitas::src::container
{
...
template <src::log::traits::logger t_logger, typename t_data,
...
requires std::move_constructible<t_data> && std::copy_constructible<t_data>
         ...
         && src::ostream::traits::has_output_operator<t_data>
