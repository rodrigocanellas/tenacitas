#ifndef TENACITAS_MEASURES_MINUTE_H
#define TENACITAS_MEASURES_MINUTE_H
...
struct minute {
  ...
  /// a \p minute object
  ///
  template <typename t_int> explicit minute(t_int p_value) { assign(p_value); }
  ...
  ///
  explicit inline minute(amount_t<minute> p_amount)
  ...
  /// \param p_amount amount of minutes used to create a \p minute
  ///
  inline minute &operator=(amount_t<minute> p_amount) {
