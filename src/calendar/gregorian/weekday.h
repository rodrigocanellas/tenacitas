...
constexpr inline days from_sunday(const weekday &p_weekday) {
  return (p_weekday - weekday::sun);
}

constexpr inline days until_saturday(const weekday &p_weekday) {
  return (weekday::sat - p_weekday);
}
