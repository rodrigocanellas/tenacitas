...
#include <calendar/gregorian/millisecond.h>
...
template <>
constexpr inline seconds
convert<milliseconds, seconds>(milliseconds p_milliseconds) {
  return seconds(p_milliseconds / static_cast<double>(1000));
}

template <>
constexpr inline minutes
convert<milliseconds, minutes>(milliseconds p_milliseconds) {
  return minutes(p_milliseconds / static_cast<double>(1000 * 60));
}

template <>
constexpr inline hours
convert<milliseconds, hours>(milliseconds p_milliseconds) {
  return hours(p_milliseconds / static_cast<double>(1000 * 60 * 60));
}

template <>
constexpr inline days convert<milliseconds, days>(milliseconds p_milliseconds) {
  return days(p_milliseconds / static_cast<double>(1000 * 60 * 60 * 24));
}

template <>
constexpr inline weeks
convert<milliseconds, weeks>(milliseconds p_milliseconds) {
  return weeks(p_milliseconds / static_cast<double>(1000 * 60 * 60 * 24 * 7));
}

template <>
constexpr inline months
convert<milliseconds, months>(milliseconds p_milliseconds) {
...
convert<milliseconds, years>(milliseconds p_milliseconds) {
...
template <>
constexpr inline milliseconds
convert<seconds, milliseconds>(seconds p_seconds) {
...
template <>
constexpr inline milliseconds
convert<minutes, milliseconds>(minutes p_minutes) {
...
template <>
constexpr inline milliseconds convert<hours, milliseconds>(hours p_hours) {
...
template <>
constexpr inline milliseconds convert<days, milliseconds>(days p_days) {
...
template <>
constexpr inline milliseconds convert<weeks, milliseconds>(weeks p_weeks) {
...
template <>
constexpr inline milliseconds convert<months, milliseconds>(months p_months) {
...
template <>
constexpr inline milliseconds convert<years, milliseconds>(years p_years) {
