...
#ifndef TENACITAS_SRC_TUPLE_TRAVERSE_TUPLE_TRAVERSE_H
#define TENACITAS_SRC_TUPLE_TRAVERSE_TUPLE_TRAVERSE_H

#include <cstddef>
#include <tuple>

#include "tenacitas/src/tuple/traits/is_tuple.h"
#include "tenacitas/src/tuple/traits/visit.h"
...
template <src::tuple::traits::is_tuple t_tuple, typename t_func,
          size_t                       t_idx = 0>
requires(
    src::tuple::traits::visit_value_in_constant_tuple<t_func, t_tuple, t_idx>)
...
template <src::tuple::traits::is_tuple t_tuple, typename t_func,
          size_t                       t_idx = 0>
requires(
    src::tuple::traits::visit_value_in_mutable_tuple<t_func, t_tuple, t_idx>)
