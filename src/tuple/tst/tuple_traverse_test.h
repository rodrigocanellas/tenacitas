...
namespace tenacitas::src::tuple::tst {
...
struct tuple_traverse_000 {
  ...
  bool operator()(const src::program::options &) {
    ...
    auto _visit = [&_ret,
                   &_char]<src::tuple::traits::is_tuple t_tuple, size_t t_idx>(
...
struct tuple_traverse_003 {
  ...
  bool operator()(const src::program::options &) {
    ...
    auto _visit = []<src::tuple::traits::is_tuple t_tuple, size_t t_idx>(
                      const t_tuple &p_tuple) {
...
struct tuple_traverse_004 {
  ...
  bool operator()(const src::program::options &) {
    ...
    auto _visit =
        []<src::tuple::traits::is_tuple t_tuple, size_t t_idx>(t_tuple &p_tuple) {
