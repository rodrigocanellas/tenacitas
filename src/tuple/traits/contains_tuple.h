...
#ifndef TENACITAS_SRC_TUPLE_TRAITS_CONTAINS_TUPLE_H
#define TENACITAS_SRC_TUPLE_TRAITS_CONTAINS_TUPLE_H
...
template <src::tuple::traits::is_tuple t_container_tuple,
          src::tuple::traits::is_tuple t_contained_tuple, std::size_t t_idx = 0>
