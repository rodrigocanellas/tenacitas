...
#ifndef TENACITAS_SRC_TUPLE_TRAITS_TRAVERSE_H
#define TENACITAS_SRC_TUPLE_TRAITS_TRAVERSE_H
...
template <src::tuple::traits::is_tuple t_tuple, typename t_func,
          std::size_t                  t_idx = 0>
requires(src::tuple::traits::visit_type_in_tuple<t_func, t_tuple, t_idx>)
