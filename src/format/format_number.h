...
#ifndef TENACITAS_SRC_FORMAT_FORMAT_NUMBER_H
#define TENACITAS_SRC_FORMAT_FORMAT_NUMBER_H
...
#include "tenacitas/src/format/align.h"
#include "tenacitas/src/format/max_str_length.h"
