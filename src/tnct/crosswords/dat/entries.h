...
struct entries
{
  ...
  inline const_entry_ite begin() const
  {
    return m_collection.begin();
  }
  inline const_entry_ite end() const
  {
    return m_collection.end();
  }

  inline entry_ite begin()
  {
    return m_collection.begin();
  }
  inline entry_ite end()
  {
    return m_collection.end();
  }
  ...
  friend std::ostream &operator<<(std::ostream &p_out, const entries &p_entries)
  {
