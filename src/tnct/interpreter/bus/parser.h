...
// #ifndef TNCT_INTERPRETER_PARSER_H
// #define TNCT_INTERPRETER_PARSER_H
...
//   void parse(string::const_iterator p_begin, string::const_iterator p_end,
//              bool p_trace = false);
...
//   static const number::fault::code error_parsing_text;
...
//     of the stack  */
// void push(memory::ptr<const grammar::production::item> p_item);
...
//   syntatic_item(memory::ptr<const grammar::production::item> p_item,
//                 symbols::iterator p_before_first)
//       : m_item(p_item), m_before_first(p_before_first) {}
// };
...
//     the @p symbols list  */
// number::u16t index(const symbol::value &p_symbol_value) const;
...
// -- -- -- -template <typename t_grammar>
//          void parser::configure_scanner(const t_grammar &p_grammar,
//                                         string::const_iterator p_begin,
//                                         string::const_iterator p_end) {
//   tin;
...
// -- -- -- -template <typename t_grammar>
//          void parser::goto_first_item(const t_grammar &p_grammar) {
//   tin;
...
// -- -- -- -template <typename t_grammar>
//          void parser::parse(string::const_iterator p_begin,
//                             string::const_iterator p_end, bool p_trace) {
...
//   /// from now on, we follow, as close as possible, the algorithm described
//   at
//   /// page 62 and 63 of "A construção de um Compilador", by Valdemar W.
//   Setzer
...
//                 throw(create_interpreter_fault(parser, error_parsing_text,
//                                                m_scanner.get_line(),
...
//       throw(
//           interpreter::fault(e, m_scanner.get_line(),
//           m_scanner.get_column()));
//     }
//   }
//   tout;
