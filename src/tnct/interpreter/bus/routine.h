...
// #ifndef TNCT_INTERPRETER_ROUTINE_H
// #define TNCT_INTERPRETER_ROUTINE_H
...
//         class routine_default {
//         public:
//             typedef string value_type;

//             static string value ( ) {
//                 return "!!no-routine-id!!";
//             }
//         };
...
//             @p routine associated tenacitas::interpreter::production::item,
...
//             the @p symbol::value @p =, the @p
//             tenacitas::interpreter::production
//             @p exp.

//             One can associate a @p routine, say @p r_var, @p r_atrib_sign and
//             @p r_exp, to each tenacitas::interpreter::production::item, via
//             the tenacitas::interpreter::grammar::set_routine method.

//             So, when @p exp is recognized, @p r_exp will be executed and a
//             list of tenacitas::interpreter::symbol objects, in this case a
...
//             /** @brief Informs the tenacitas::interpreter::routine_id of this
//             @p
//                 routine */
...
//                 tenacitas::interpreter::symbol; it is not a valid symbol, but
//                 a "mark" of the end of the collection, just like in the
//                 standard containers

//                 @return a (possibly new) tenacitas::interpreter::symbol,
...
//         typedef identifier::id <string,
//                                 identifier::validator<string>,
//                                 production_default> production_id;

//         /** @brief tenacitas::interpreter::routine to be associated to a
//             tenacitas::interpreter::grammar::production::item that references
//             a tenacitas::interpreter::grammar::production
...
//         /** @brief tenacitas::interpreter::routine to be associated to a
//             tenacitas::interpreter::grammar::production::item that references
//             a tenacitas::interpreter::grammar::symbol::value
...
//         /** @brief tenacitas::interpreter::routine to be associated to a
//             tenacitas::interpreter::grammar::production::item that references
//             a tenacitas::interpreter::grammar::symbol::type
...
//             /** @brief Adds a tenacitas::interpreter::routine to the
//             collection
...
//                 @param [in] p_rout_id id the
//                 tenacitas::interpreter::routine_id used to find a <tt>
//                 memory::ptr<const routine> </tt>

//                 @return a valid <tt> memory::ptr<const routine> </tt>, if
//                 found
