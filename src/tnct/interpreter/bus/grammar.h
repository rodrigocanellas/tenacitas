...
//             static string value ( ) {
//                 return "!!no-grammar-id!!";
//             }
//         };

//         /** @brief Grammar identifier */
//         typedef identifier::id<string,
//                                identifier::validator<string>,
//                                grammar_default> grammar_id;
...
//             memory::ptr<const type_recognizers> get_type_recognizers ( )
//             const;
...
//             void add_grammar( ) throw ( number::fault );
...
//             void add_type_recognizer ( memory::ptr<const type_recognizer>
//                                        p_recognizer ) throw ( number::fault
//                                        );
...
//             void add_routine( memory::ptr<const routine> p_rout )
//                 throw ( number::fault );
...
//                 reference
//                 @p p_routine */
//             void add_production_routine ( memory::ptr<const
//             production_routine>
//                                           p_routine ) ;
...
//             void add_type_routine ( memory::ptr<const symbol_type_routine>
//                                     p_routine ) ;
...
//                 </tt> to reference @p p_routine  */
//             void add_value_routine ( memory::ptr<const symbol_value_routine>
//                                      p_routine );
...
//             bool already_imported ( memory::ptr<const grammar> p_grammar )
//             const;
...
//             void
//             add_symbol_type_routine ( memory::ptr<const symbol_type_routine>
//                                       p_routine );

//             void
//             add_symbol_value_routine ( memory::ptr<const
...
//                   memory::ptr<const production> p_prod = 0 );
...
//                 production_routine  */
//             void set_production_routine ( memory::ptr<const
//             production_routine>
//                                           p_routine ) ;
...
//                 symbol_type_routine  */
//             void
//             set_symbol_type_routine ( memory::ptr<const symbol_type_routine>
//                                       p_routine ) ;

//             /** @brief Defines that this item references a @p
//                 symbol_type_routine  */
//             void
//             set_symbol_value_routine ( memory::ptr<const
//             symbol_value_routine>
//                                        p_routine ) ;
...
//                 referenced by this @p item  */
//             void
//             set_symbol_value ( memory::ptr<const symbol::value>
//             p_symbol_value );
...
// void
// grammar::
// add_grammar ( ) throw ( number::fault )  {
