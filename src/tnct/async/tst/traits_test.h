...
struct traits_event_000
{
  ...
  {
    static_assert(
        !async::traits::is_event<event_a>,
        "'event_a' is not compatible with async::traits::event<event_a>");
...
struct traits_event_004
{
  ...
  {
    static_assert(
        !async::traits::is_event<event_004_event_a>,
        "'event_a' is not compatible with async::traits::event<event_a>");
...
struct traits_event_005
{
  ...
  bool operator()(const program::options &)
  {
    static_assert(
        async::traits::is_event<event_a>,
        "'event_a' is compatible with async::traits::event<event_a>");
...
struct traits_add_handler_000
{
  static std::string desc()
  {
    return "A struct not compatible with "
           "'async::traits::handler' because it does not "
           "implement call operator that receives a 'event' rvalue";
  }
  bool operator()(const program::options &)
  {
    static_assert(!async::traits::is_handler<traits_add_handler_000,
                                                  add_handler_tests_event>,
                  "'handler_000' is not compatible with "
                  "async::traits::handler ");

    return true;
  }
};

struct traits_add_handler_001
{
  static std::string desc()
  {
    return "A struct not compatible with "
           "'async::traits::handler' because it implements a "
           "call operator that receives a 'event' rvalue, but it returns bool";
  }
  bool operator()(const program::options &)
  {
    static_assert(!async::traits::is_handler<traits_add_handler_001,
                                                  add_handler_tests_event>,
                  "'handler_000' is not compatible with "
                  "async::traits::handler ");
...
struct traits_add_handler_002
{
  ...
  bool operator()(const program::options &)
  {
    static_assert(!async::traits::is_handler<traits_add_handler_002,
                                                  add_handler_tests_event>,
                  "'handler_000' is not compatible with "
                  "async::traits::handler ");
...
struct traits_add_handler_003
{
  ...
  bool operator()(const program::options &)
  {
    static_assert(!async::traits::is_handler<traits_add_handler_003,
                                                  add_handler_tests_event>,
                  "'handler_000' is not compatible with "
                  "async::traits::handler ");
...
struct traits_add_handler_004
{
  ...
  bool operator()(const program::options &)
  {
    static_assert(!async::traits::is_handler<traits_add_handler_004,
                                                  add_handler_tests_event>,
                  "'handler_000' is not compatible with "
                  "async::traits::handler ");
...
struct traits_add_handler_005
{
  static std::string desc()
  {
    return "A struct compatible with 'async::traits::handler' ";
  }
  bool operator()(const program::options &)
  {
    static_assert(async::traits::is_handler<traits_add_handler_005,
                                                 add_handler_tests_event>,
                  "'handler_000' is not compatible with "
                  "async::traits::handler ");
...
struct traits_dispatcher_000
{
  ...
  bool operator()(const program::options &)
  {
    ...
    static_assert(
        async::traits::is_dispatcher<my_dispatcher, event_a, event_c>,
        "'my_dispatcher should be compatible with async::traits");
...
private:
  ...
  template <async::traits::is_event... t_events>
  struct dispatcher
  {
  ...
  template <async::traits::is_dispatcher<event_a, event_b> t_dispatcher>
  void f(t_dispatcher &)
  {
  }
};

struct traits_has_add_handling_method_000
{
  static std::string desc()
  {
    return "Checks for async::traits::has_add_handling_method";
  }
...
struct traits_has_add_handling_method_001
{
  static std::string desc()
  {
    return "Checks for async::traits::has_add_handling_method";
...
struct traits_has_publish_method_000
{
  static std::string desc()
  {
  ...
  bool operator()(const program::options &)
  {
    ...
    static_assert(async::traits::has_publish_method<publisher, event_a>,
                  "'publisher' should be compatible with "
                  "'async::traits::has_publish_method'");
    return true;
  }
...
struct traits_has_publish_method_001
{
  static std::string desc()
  {
  ...
  bool operator()(const program::options &)
  {
    ...
    static_assert(!async::traits::has_publish_method<publisher, event_b>,
...
struct traits_has_publish_method_002
{
  static std::string desc()
  {
    return "A valid has_publish_method";
  ...
  bool operator()(const program::options &)
  {
    ...
    static_assert(
        async::traits::has_publish_method<publisher, event_a, event_b>,
        "'publisher' should be compatible with "
        "'async::traits::has_publish_method'");
    return true;
  }
...
private:
  ...
  struct publisher
  {
    ...
    template <async::traits::is_event t_event, typename... t_params>
...
struct traits_handler_001
{
  static std::string desc()
  {
    return "A lambda function that is not "
           "async::traits::is_handler conformance";
  }
  bool operator()(const program::options &)
  {
    auto _handle = []() {};

    static_assert(!async::traits::is_handler<decltype(_handle), event>,
                  "'auto _handle = []() {}' is not conformance to "
                  "async::traits::is_handler");
...
struct traits_handler_002
{
  static std::string desc()
  {
    return "A 'handle' class that is async::traits::is_handler "
           "conformance";
  }
  bool operator()(const program::options &)
  {

    static_assert(async::traits::is_handler<handle, event>,
...
//   static std::string desc()
//   {
//     return "A 'event' class is not conformant to 'async::traits::event'
//     "
...
//   {
//     static_assert(
//         !async::traits::event<event>,
//         "'event' should not be  conformant to 'async::traits::event' "
...
//   static std::string desc()
//   {
//     return "A 'event' class is conformant to 'async::traits::event'";
//   }
...
//     static_assert(
//         async::traits::event<event>,
//         "'event' should be  conformant to 'async::traits::event' ");
...
//   bool operator()(const program::options &)
//   {
//     static_assert(async::traits::result<result_like>, "This compiles");
//     return true;
//   }
// };
