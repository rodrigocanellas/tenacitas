...
#ifndef TNCT_ASYNC_TRAITS_CONTAINS_ONLY_EVENTS_H
#define TNCT_ASYNC_TRAITS_CONTAINS_ONLY_EVENTS_H
...
{
  return (async::traits::is_event<std::tuple_element_t<t_idx, t_tuple>>
          && ...);
