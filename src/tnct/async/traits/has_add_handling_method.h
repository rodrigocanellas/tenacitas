...
#ifndef TNCT_ASYNC_TRAITS_HAS_ADD_HANDLING_METHOD_H
#define TNCT_ASYNC_TRAITS_HAS_ADD_HANDLING_METHOD_H
...
concept has_add_handling_method =
    async::traits::is_event<t_event>
    && container::traits::queue<t_queue, t_event>
    && async::traits::is_handler<t_handler, t_event>
