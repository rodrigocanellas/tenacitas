...
#ifndef TNCT_SUPPLIER_CPT_REFERENCE_SUPPLIER_H
#define TNCT_SUPPLIER_CPT_REFERENCE_SUPPLIER_H
...
concept reference_supplier = requires {
              ...
              requires(std::remove_cvref_t<t_supplier> &p_supplier) {
                {
                  p_supplier.get(meta_class<t_object>{},
                      ...
                      std::optional<std::reference_wrapper<t_object>>>;
              };
};
