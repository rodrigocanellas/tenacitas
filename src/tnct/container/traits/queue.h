...
#ifndef TNCT_TRAITS_QUEUE_CONTAINER_H
#define TNCT_TRAITS_QUEUE_CONTAINER_H
...
namespace tnct::container::traits
{
...
concept queue =
    ...
    ostream::traits::has_output_operator<typename t::data> &&
