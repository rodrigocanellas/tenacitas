...
struct matrix_003 {
  ...
  bool operator()(const program::bus::options &) {
    ...
    return (
        (_matrix->get_cell(0, 0) == 'o') && (_matrix->get_cell(0, 1) == 'p') &&
        (_matrix->get_cell(0, 2) == 'e') && (_matrix->get_cell(0, 3) == 'n'));
  }
};
...
struct matrix_004 {
  ...
  bool operator()(const program::bus::options &) {
    ...
    return (
        (_matrix->get_cell(0, 0) == 'o') && (_matrix->get_cell(1, 0) == 'p') &&
        (_matrix->get_cell(2, 0) == 'e') && (_matrix->get_cell(3, 0) == 'n'));
  }
};
