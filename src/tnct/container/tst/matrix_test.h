...
struct matrix_000
{
  ...
  bool operator()(const program::bus::options &)
  {
    ...
    if (_matrix(1, 2) != 'z')
    {
      _log.err(format::bus::fmt("container::dat::matrix(1,2) should be 'z', but it is '",
                           _matrix(1, 2), '\''));
      return false;
    }
    _log.tst(format::bus::fmt("container::dat::matrix(1,2) is '", _matrix(1, 2), '\''));
    return true;
  }
};
...
struct matrix_001
{
  ...
  bool operator()(const program::bus::options &)
  {
    ...
    if (_matrix(1, 2) != 'e')
    {
      _log.err(format::bus::fmt("container::dat::matrix(1,2) should be 'e', but it is '",
                           _matrix(1, 2), '\''));
      return false;
    }
...
struct matrix_002
{
  ...
  bool operator()(const program::bus::options &)
  {
    ...
    if (_matrix(1, 2) != -1)
    {
      _log.err(format::bus::fmt("container::dat::matrix(1,2) should be -1, but it is '",
                           _matrix(1, 2), '\''));
      return false;
    }
    _log.tst(format::bus::fmt("container::dat::matrix(1,2) is '", _matrix(1, 2), '\''));
    ...
    if (_matrix(1, 2) != 6)
    {
      _log.err(format::bus::fmt("container::dat::matrix(1,2) should be 6, but it is '",
                           _matrix(1, 2), '\''));
      return false;
    }
