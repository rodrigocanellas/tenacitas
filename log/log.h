...
#ifndef TENACITAS_LIB_LOG_INTERNAL_LOG_H
#define TENACITAS_LIB_LOG_INTERNAL_LOG_H

#include <tenacitas.lib/log/internal/log_file.h>
#include <tenacitas.lib/log/internal/log_wrapper.h>
