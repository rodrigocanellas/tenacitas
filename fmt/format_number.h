...
#ifndef TENACITAS_LIB_FMT_FORMAT_NUMBER_H
#define TENACITAS_LIB_FMT_FORMAT_NUMBER_H
...
#include <tenacitas.lib/fmt/internal/max_str_length.h>

namespace tenacitas::lib::fmt {
