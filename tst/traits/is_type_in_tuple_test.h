...
struct is_type_in_tuple_000 {
  ...
  bool operator()(const src::program::options &) {
    ...
    auto _found{src::traits::tuple::contains_type<my_tuple, int>()};
    if (!_found) {
    ...
    _found = src::traits::tuple::contains_type<my_tuple, char>();
    if (!_found) {
    ...
    _found = src::traits::tuple::contains_type<my_tuple, float>();
    if (!_found) {
...
struct is_type_in_tuple_001 {
  ...
  bool operator()(const src::program::options &) {
    ...
    auto _found{src::traits::tuple::contains_type<my_tuple, std::string>()};
    if (_found) {
