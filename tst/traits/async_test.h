...
private:
  ...
  template <src::traits::async::event... t_events> struct dispatcher {
...
private:
  ...
  template <src::traits::async::has_const_lvalue_publish_method<result, event_a>
...
private:
  ...
  template <src::traits::async::event... t_events> struct publisher {
    // using events = std::tuple<event_a>;
    // template <src::traits::async::event t_event> result publish(const t_event
    // &) {
    //   return result::r0;
    // }
  };
...
struct has_publish_method_002 {
  ...
  bool operator()(const src::program::options &) {
    static_assert(
        src::traits::async::has_const_lvalue_publish_method<publisher, result,
                                                            event_a>,
...
struct has_add_handling_method_002 {
  ...
  bool operator()(const src::program::options &) {
    ...
    static_assert(
        !src::traits::async::handler<handling_a::handler, handling_a::event>);
    static_assert(!src::traits::async::handling_definition<handling_a>);
...
struct has_add_handling_method_004 {
  ...
  bool operator()(const src::program::options &) {
    static_assert(
        !src::traits::container::queue<handling_a::queue, handling_a::event>);
    static_assert(!src::traits::async::handling_definition<handling_a>);
    // dummy _dummy;
    // foo(_dummy);
...
struct has_add_handling_method_006 {
  static std::string desc() {
    return "Check if src::traits::async::has_add_handling_method captures in "
           ...
           "does not conform to 'src::traits::async::result";
  }
...
struct handling_priority_000 {
  ...
  bool operator()(const src::program::options &) {
    ...
    //               "priority_000 is not src::traits::async::handling_priority
    //               " "conformant");
...
struct handler_000 {
  ...
  bool operator()(const src::program::options &) {
    ...
    static_assert(src::traits::async::handler<decltype(_handler), event>,
...
struct handler_001 {
  ...
  bool operator()(const src::program::options &) {
    ...
    static_assert(!src::traits::async::handler<decltype(_handle), event>,
...
struct handler_002 {
  static std::string desc() {
    return "A 'handle' class that is src::traits::async::handler conformance";
  }
  bool operator()(const src::program::options &) {

    static_assert(
        src::traits::async::handler<handle, event>,
