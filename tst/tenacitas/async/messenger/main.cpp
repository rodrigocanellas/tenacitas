...
struct messenger_000 {
    ...
    bool operator()() {
        ...
        number::id _id = async::add_handlers<data>(_subscriber_timeout,
...
struct messenger_002 {
    ...
    bool operator()() {
        ...
        DEB(m_log, "waiting for the consumer to notify");
        {
            ...
            if (_status == cv_status::timeout) {
                INF(m_log, "it took more time than allowed for the consumer, "
                           "as expected");
                //        messenger::wait();
                return true;
            }
...
struct messenger_007 {
    ...
    bool operator()() {
        ...
        sleeping_loop _loop{m_id, _producer, m_sleeping_loop_timeout,
                            m_interval};
