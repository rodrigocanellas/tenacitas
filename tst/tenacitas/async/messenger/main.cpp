...
struct test_t {
    ...
    test_t(handlers_definitions &&p_handlers_definitions,
        ...
        , m_num_senders(static_cast<decltype(m_num_senders)>(
              m_senders_definitions.size()))
        , m_num_handlers(static_cast<decltype(m_num_handlers)>(
              m_handlers_definitions.size())) {}
...
private:
    ...
    static constexpr uint16_t m_max_msgs_timeout {m_total_msgs /
