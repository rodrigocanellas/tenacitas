...
// data message
template <msg_id id = 'A'> struct msg_t {
...
//      async::internal::handlers_t<msg<id>> ::add_data(update{id, m_pool_num,
//      m_sub_id, m_number}); m_function(p_msg);
//    }
//  };
...
//      async::internal::handlers_t<msg<id>> ::add_data(end_publishing{id,
//      m_publish_id, m_msg.get_value()}); return;
//    }

//    DEB(m_log, "publishing ", m_msg);
//    async::internal::handlers_t<msg<id>> ::add_data(m_msg);
//    ++m_msg;
//  }
...
//    async::internal::handlers_t<internal::end_publishing> ::add_handler(
...
//    //    async::internal::messenger_t<msg<id>,
...
//    internal::publisher _publisher(p_owner, 500ms, p_interval,
//                                   [&_added]() -> void { _added(); });
