...
template <traits::tuple::like t_container, traits::tuple::like t_contained>
// requires traits::tuple::contains_tuple<t_container, t_contained>
void func() {}
...
struct tuple_contains_tuple_000 {
  ...
  bool operator()(const program::options &) {
    ...
    static_assert(traits::tuple::contains_tuple_helper<tuple_1, tuple_2>());
