...
//           "thread will sleep for 5 secs, the new 'sleeping_loop' will stop
//           in " "its destructor."
...
//           "\nA 'sleeping_loop' will be started, the main thread will sleep
//           " "for 10 secs, the 'sleeping_loop' will be stopped, another "
//           "'sleeping_loop' will be created using the same parameters as
//           first " "one, the new 'sleeping_loop' will be started, the main
//           thread will " "sleep for 5 secs, the new 'sleeping_loop' will be
...
//           "\nThe first one increments a counter by 1; the second by 100,
//           and " "the third by 1000."

//           "\nAll will be started, the main thread will sleep for 6 secs,
//           and " "the all 'sleeping_loop' will stopped by theirs
//           destructors."
...
//           "\nAll will be started, the main thread will sleep for 6 secs,
//           the " "second 'sleeping_loop' will be stopped, the main thread
//           will sleep " "for seconds all 'sleeping_loop' will stopped by
//           theirs destructors."
...
//           "\nAll will be started, the main thread will sleep for 12 secs,
//           and " "the all 'sleeping_loop' will stopped by calling stop."

//           "\nCounter 1 should be 12, counter 2 should be 1200, and counter
//           3 " "should be 12000.";
//  }
//  logger::cerr::log m_log{"sleeping_loop_010:"};
//};
...
//           "\nAll will be started, the main thread will sleep for 12 secs,
//           all " "the loops will be stopped by calling 'stop', the main
