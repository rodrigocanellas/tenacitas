...
#ifndef TENACITAS_LIB_ASYNC_HANDLINGS_H
#define TENACITAS_LIB_ASYNC_HANDLINGS_H
...
struct handlings_000 {
  static std::string desc() {
    return "Simple 'src::async::handlings' creation";
  }
  ...
  bool operator()(const src::program::options &) {
    ...
    using handlings =
        src::async::handlings<logger, event_1, handling_1a, handling_1b>;
...
private:
  ...
  using queue_1a = src::container::circular_queue<logger, event_1, 10>;

  using queue_1b = src::container::circular_queue<logger, event_1, 200>;
  ...
  using handling_1a =
      src::async::handling<logger, event_1, queue_1a, handler_1a>;

  using handling_1b =
      src::async::handling<logger, event_1, queue_1b, handler_1b>;
};
...
struct handlings_001 {
  ...
  bool operator()(const src::program::options &) {
    ...
    // using handlings =
    //     src::async::handlings<logger, event_1, handling_1, handling_2>;
...
private:
  ...
  using handling_1 =
      src::async::handling<logger, event_1, queue_1, handler_1>;
  ...
  using queue_2 = src::container::circular_queue<logger, event_2, 200>;

  using handling_2 =
      src::async::handling<logger, event_2, queue_2, handler_2>;
};

struct handlings_002 {
  static std::string desc() {
    return "Not compiling because there there is a 'traits::handler' that is "
           "associated to two differente 'src::async::handlings'";
  }
  ...
  bool operator()(const src::program::options &) {
    ...
    // /// \attention THIS DOES NOT COMPILE, AS EXPECTED
    // using handlings =
    //     src::async::handlings<logger, event_1, handling_1a,
    //     handling_1b>;
...
private:
  ...
  using handling_1a =
      src::async::handling<logger, event_1, queue_1a, handler_1>;

  using queue_1b = src::container::circular_queue<logger, event_1, 30>;

  using handling_1b =
      src::async::handling<logger, event_1, queue_1b, handler_1>;
};
...
struct handlings_003 {
  ...
  bool operator()(const src::program::options &) {
    ...
    using handlings = src::async::handlings<logger, event_1, handling_1>;
    ...
    src::async::result _result{
        _handlings.get_num_handlers<handling_1>(_num_handlers)};

    if (_result != src::async::result::OK) {
      TNCT_LOG_ERR(_logger, src::generic::fmt("result = ", _result));
      return false;
    }
    if (_num_handlers != 1U) {
      TNCT_LOG_ERR(_logger,
                   src::generic::fmt("number of handlers should be 1 but it is = ",
                                _num_handlers));
      return false;
    }
    ...
    TNCT_LOG_TST(
        _logger,
        src::generic::fmt("number of handlers should be 1 and it is actually = ",
                     _num_handlers))
...
struct handlings_004 {
  ...
  bool operator()(const src::program::options &) {
    ...
    if (_num_handlers != 3U) {
      TNCT_LOG_ERR(_logger,
                   src::generic::fmt("number of handlers should be 3 but it is = ",
                                _num_handlers));
      return false;
    }
    ...
    TNCT_LOG_TST(
        _logger,
        src::generic::fmt("number of handlers should be 3 and it is actually = ",
                     _num_handlers))
...
struct handlings_005 {
  ...
  bool operator()(const src::program::options &) {
    ...
    src::async::result _result{_handlings.add_event<handling_1>(event_1{-1})};
    if (_result != src::async::result::OK) {
      TNCT_LOG_ERR(_logger, src::generic::fmt("error: ", _result));
      return false;
    }
    ...
    if (_i != -3) {
      TNCT_LOG_ERR(_logger, src::generic::fmt("i should be -3, but it is ", _i));
      return false;
    }
...
private:
  ...
  struct handler_1 {
    ...
    void operator()(event_1 &&p_event) {
      ...
      *m_i = p_event.i - 2;
      TNCT_LOG_TST(m_logger, src::generic::fmt("*m_i is now ", *m_i));
    }
  ...
  bool operator()(const src::program::options &) {
    ...
    while (!_handlings.is_stopped<handling_1>()) {
      ...
      if (_counter == 14) {
        ...
        if (_result != src::async::result::OK) {
          TNCT_LOG_ERR(_logger,
                       src::generic::fmt("result is ", _result,
                                    ", but is should be ", src::async::result::OK));
          return false;
        }
        if (!_handlings.is_stopped<handling_1>()) {
          TNCT_LOG_ERR(
              _logger,
              src::generic::fmt("handlings should be stopped, but it is not"));
          return false;
        }
        TNCT_LOG_TST(_logger,
                     src::generic::fmt("handlings is stopped, as it should"))
      } else {
        ++_counter;
      }
    }
...
private:
  ...
  struct handler_1 {
    ...
    void operator()(event_1 &&p_event) {
      ...
      TNCT_LOG_TST(m_logger, src::generic::fmt("p_event.i = ", p_event.i));
    }
...
struct handlings_007 {
  ...
  bool operator()(const src::program::options &) {
    ...
    TNCT_LOG_TST(_logger, src::generic::fmt(_handlings));
...
private:
  ...
  struct handler_1a {
    ...
    void operator()(event_1 &&p_event) {
      ...
      TNCT_LOG_TST(m_logger, src::generic::fmt("*m_i is now ", p_event.i));
    }
  ...
  struct handler_1b {
    ...
    void operator()(event_1 &&p_event) {
      TNCT_LOG_TST(m_logger, src::generic::fmt("p_event * 2 is ", p_event.i * 2));
    }
...
//   using queue = src::container::circular_queue<logger, t_event>;

//   template <traits::event t_event>
//   using handlings_t = src::async::handlings<logger, t_event>;
...
//         "1", _sub_1, 0, src::async::handling_priority::medium, 10);

//     if (_result != src::async::result::OK) {
//       m_logger.err(src::generic::fmt("error: ", _result));
//       return false;
//     }

//     subscriber_2 _sub_2(m_logger);
//     _result = _eql.add_handling<subscriber_2>(
//         "2", _sub_2, 0, src::async::handling_priority::medium, 10);
...
//     m_logger.tst(src::generic::fmt("events handlings: ", _eql));
...
//         "1", _sub, 1, src::async::handling_priority::medium, 10));
//     if (_result != src::async::result::OK) {
//       m_logger.err(src::generic::fmt("error: ", _result));
//       return false;
//     }
...
//     src::async::handling_id _handling_id_1("handling 1");
...
//         src::async::handling_priority::medium, 10));
//     if (_result != src::async::result::OK) {
//       m_logger.err(src::generic::fmt("error: ", _result));
//       return false;
//     }
...
//     src::async::handling_id _handling_id_2("handling 2");
...
//     using event_generator = src::async::sleeping_loop<logger>;
//     auto _generate = [&]() {
//       auto _result(_handlings.add_event(ev1()));
//       if (_result != src::async::result::OK) {
//         m_logger.err(src::generic::fmt(_result));
//       }
//     };
//     event_generator _event_generator(_log, _generate, 10ms);
//     _event_generator.start();

//     _log.tst(src::generic::fmt("waiting for all ", m_amount_events * 2,
...
//       _log.tst(src::generic::fmt("handling ", _handling_id_1, ", thread ",
//                             _value.first, " handled ", _value.second,
//                             " events"));
//       _total += _value.second;
//     }

//     _log.tst(src::generic::fmt("total handled by ", _handling_id_1, " = ",
//     _total));

//     _total = 0;
//     for (const auto &_value : _map_2) {
//       _log.tst(src::generic::fmt("handling ", _handling_id_2, ", thread ",
//                             _value.first, " handled ", _value.second,
//                             " events"));
//       _total += _value.second;
//     }

//     _log.tst(src::generic::fmt("total handled by ", _handling_id_2, " = ",
//     _total));
...
//       m_logger.tst(src::generic::fmt("handler 1, thread ",
...
//         "1", _sub_1, 1, src::async::handling_priority::medium, 10));
...
//         "2", _sub_2, 1, src::async::handling_priority::medium, 10);
//     if (_result != src::async::result::OK) {
//       m_logger.err(src::generic::fmt("error: ", _result));
//       return false;
//     }
...
//         "2", _sub, 1, src::async::handling_priority::medium, 10);
//     if (_result != src::async::result::HANDLER_USED) {
//       m_logger.err(src::generic::fmt("error: ", _result));
//       return false;
//     }
//     return true;
...
//     auto _result(src::async::result::OK);
...
//         "handling-000", _sub, 1, src::async::handling_priority::high, 10);
//     if (_result != src::async::result::OK) {
//       m_logger.err(src::generic::fmt(_result));
//       return false;
//     }
...
//     void handle(ev1 &&) {
//       m_logger.tst(src::generic::fmt("calls = ", ++calls));
