#ifndef TENACITAS_BUSINESS_CROSSWORDS_POSITIONER_001_H
#define TENACITAS_BUSINESS_CROSSWORDS_POSITIONER_001_H
...
//#include <business/crosswords/internal/words_by_size.h>
...
//    words operator()()
//    {
//        std::sort(m_words.begin(), m_words.end(), entities::crosswords::cmp_words());
//        group_words();
