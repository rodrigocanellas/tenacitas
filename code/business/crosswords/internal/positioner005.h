#ifndef TENACITAS_BUSINESS_CROSSWORDS_POSITIONER005_H
#define TENACITAS_BUSINESS_CROSSWORDS_POSITIONER005_H
...
/// \brief positioner005_t position \p words
///
