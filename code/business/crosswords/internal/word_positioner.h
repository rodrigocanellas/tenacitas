#ifndef TENACITAS_BUSINESS_CROSSWORDS_WORD_POSITIONER_H
#define TENACITAS_BUSINESS_CROSSWORDS_WORD_POSITIONER_H
...
/// \brief word_positioner_t positions a word within a set of words
///
...
private:
  ...
  bool position_first(words::iterator p_to_position, x p_x_limit, y p_y_limit)
  {
    ...
    if (_ite != m_last_position_when_first.end()) {
      ...
      m_last_position_when_first.emplace(_lexeme, first_position::UP_LEFT);
