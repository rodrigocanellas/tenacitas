#ifndef TENACITAS_BUSINESS_CROSSWORDS_WORDS_BY_SIZE_H
#define TENACITAS_BUSINESS_CROSSWORDS_WORDS_BY_SIZE_H
...
#include <business/crosswords/internal/position_word.h>
...
struct words_by_size_t
{
    ...
    typedef entities::crosswords::lexeme::size_type size;
                  ...
                  positions_occupied& p_positions_occupied)
    {
        ...
        if (!m_limits_defined) {
            ...
            std::sort(m_begin, m_end, entities::crosswords::cmp_words());
        }
        ...
        while (true) {
            ...
            for (words::iterator _ite = m_begin; _ite != m_end; ++_ite) {
                if (!_position_word(p_words,
                    ...
                    _positoned = false;
                    entities::crosswords::print(p_x_limit, p_y_limit, p_words);
            ...
            if (!std::next_permutation(m_begin, m_end, entities::crosswords::cmp_words())) {
                break;
            }
        }
        return _positoned;
