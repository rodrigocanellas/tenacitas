#ifndef TENACITAS_BUSINESS_CROSSWORDS_WORDS_POSITIONER_H
#define TENACITAS_BUSINESS_CROSSWORDS_WORDS_POSITIONER_H
...
struct words_positioner_t
{
  ...
  bool operator()(messages::crosswords::stop_positioning p_stop_positioning)
  {
  ...
  bool operator()(messages::crosswords::to_position<log>&& p_to_position)
  {
    ...
    //                         entities::crosswords::print_positioned(_begin, _end,
    //                                                    m_x_limit,
    //                                                    m_y_limit));
    ...
    while (true) {
      ...
      if (m_position_first_status == position_first_status::done) {
        ...
        dispatcher_not_positioned::publish(
          messages::crosswords::not_positioned(m_words));
      }
      ...
      while (true) {
        ...
        if (_ite == _end) {
          ...
          dispatcher_positioned::publish(
            messages::crosswords::positioned<log>(m_words, m_positions_occupied));
          break;
        }
