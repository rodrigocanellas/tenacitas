#ifndef TENACITAS_BUSINESS_CROSSWORDS_POSITIONING_HISTORY_H
#define TENACITAS_BUSINESS_CROSSWORDS_POSITIONING_HISTORY_H
...
#include <business/crosswords/internal/words_references.h>
