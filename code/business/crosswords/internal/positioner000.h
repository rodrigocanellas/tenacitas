#ifndef TENACITAS_BUSINESS_CROSSWORDS_POSITIONER_000_H
#define TENACITAS_BUSINESS_CROSSWORDS_POSITIONER_000_H
...
//        log_positioned();
//        // std::this_thread::sleep_for(std::chrono::milliseconds(8000)); if
//        (position_words()) {
//            optimize_words();
//        }
//        return m_words;
...
//    {
//        crosswords_log_debug(log, "ordering words by lexeme size,
//        descending"); std::sort(m_words.begin(),
//                  m_words.end(),
...
//              _pos->get_y0(),
//              ":",
//              (_pos->get_direction() == word::direction::vertical ? "V" :
//              "H"),
//              ":",
...
//    //            return true;
//    //        }
//    //        words_pointers::const_iterator _positioned_end =
//    //        m_positioned.end(); words_pointers::const_iterator
//    _positioned_ite
//    //        = m_positioned.begin(); while (true) {
...
//            p_word->get_y0()); if (_occupied.first) {
//                crosswords_log_debug(log,
//                                     "(",
//                                     p_word->get_xn() + x(1),
//                                     ",",
...
//                                 const intersections& /*p_intersections*/)
//                                 const
//    {
//        std::pair<bool, char> _occupied({ false, ' ' });
//        if (p_word->get_y0() != y(0)) {
//            _occupied = is_occupied(p_word->get_x0(), p_word->get_y0() -
//            y(1));
...
//            _occupied = is_occupied(p_word->get_x0(), p_word->get_yn() +
//            y(1)); if (_occupied.first) {
//                crosswords_log_debug(log,
//                                     "(",
//                                     p_word->get_x0(),
//                                     ",",
...
//        //            if (p_word->get_yn() != (m_y_limit - y(1))) {
//        //                _occupied =
//        //                  is_occupied(p_word->get_x0(), p_word->get_yn() +
//        //                  y(1));
//        //                if (_occupied.first) {
//        //                    crosswords_log_debug(log,
//        //                                         "(",
...
//            if (p_word->get_x0() != x(0)) {
//                _occupied =
//                  is_occupied(_coords[_i].get_x() - x(1),
//                  _coords[_i].get_y());
//                if (_occupied.first) {
//                    crosswords_log_debug(log,
//                                         "(",
...
//            if (p_word->get_y0() != y(0)) {
//                _occupied =
//                  is_occupied(_coords[_i].get_x(), _coords[_i].get_y() -
//                  y(1));
//                if (_occupied.first) {
//                    crosswords_log_debug(log,
//                                         "(",
