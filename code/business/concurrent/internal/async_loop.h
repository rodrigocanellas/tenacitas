#ifndef TENACITAS_BUSINESS_CONCURRENT_ASYNC_LOOP_H
#define TENACITAS_BUSINESS_CONCURRENT_ASYNC_LOOP_H
...
#include <business/concurrent/internal/loop.h>
...
private:
  ...
  typedef concurrent::thread thread_t;
