#ifndef TENACITAS_BUSINESS_LOGGER_LOG_H
#define TENACITAS_BUSINESS_LOGGER_LOG_H
...
#include <business/logger/internal/level.h>
#include <business/type/enum.h>
                    ...
                    const t_params&... p_params)
  {
    if (can_log(p_level)) {
      ...
      _stream << "" << level2str(p_level) << m_separator
              << tenacitas::business::calendar::epoch::millisecs()
