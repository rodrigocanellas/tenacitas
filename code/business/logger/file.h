#ifndef TENACITAS_BUSINESS_LOGGER_FILE_H
#define TENACITAS_BUSINESS_LOGGER_FILE_H
...
#include <business/logger/internal/file_writer.h>
  ...
  const std::string& p_closed_extension = "closed")
{
    ...
    logger::log::configure([_file_writer_ptr](std::string&& p_str) -> void {
