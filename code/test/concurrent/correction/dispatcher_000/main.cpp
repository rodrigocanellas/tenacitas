...
public:
  concurrent::result operator()()
  {
    ...
    i += 10;
    msg_a _msg_a(i);
    concurrent_log_test(logger::log, "P 2", _msg_a);
    concurrent::dispatcher_t<msg_a, logger::log>::publish(_msg_a);

    d *= 2.5;
    msg_c _msg_c(d);
    concurrent_log_test(logger::log, "P 2", _msg_c);
    concurrent::dispatcher_t<msg_c, logger::log>::publish(_msg_c);
...
public:
  concurrent::result operator()()
  {
    ...
    concurrent_log_test(logger::log, "P 3", _msg_b);
    concurrent::dispatcher_t<msg_b, logger::log>::publish(_msg_b);
...
struct subscriber_1
{
  concurrent::result operator()(msg_a&& p_msg)
  {
    using namespace tenacitas::business;
    concurrent_log_test(logger::log, "S 1", p_msg);
    return concurrent::result::dont_stop;
  }
};
...
struct subscriber_2
{
  ...
  {
    using namespace tenacitas::business;
    concurrent_log_test(logger::log, "S 2", p_msg);
    return concurrent::result::dont_stop;
  }

  concurrent::result operator()(msg_b&& p_msg)
  {
    using namespace tenacitas::business;
    concurrent_log_test(logger::log, "S 2", p_msg);
    return concurrent::result::dont_stop;
...
struct subscriber_3
{
  ...
  {
    using namespace tenacitas::business;
    concurrent_log_test(logger::log, "S 3", p_msg);
    return concurrent::result::dont_stop;
  }
};
...
struct subscriber_4
{
  ...
  {
    using namespace tenacitas::business;
    concurrent_log_test(logger::log, "S 4", p_msg);
    return concurrent::result::dont_stop;
  }
  ...
  concurrent::result operator()(msg_c&& p_msg)
  {
    using namespace tenacitas::business;
    concurrent_log_test(logger::log, "S 4", p_msg);
    return concurrent::result::dont_stop;
...
struct dispatcher_000
{
  ...
  bool operator()()
  {
    ...
    concurrent_log_test(logger::log, "------> starting to sleep");
