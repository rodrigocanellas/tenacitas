#ifndef TENACITAS_CALENDAR_ENTITIES_HOUR_H
#define TENACITAS_CALENDAR_ENTITIES_HOUR_H
...
struct hour
{
  ...
  static hour create(t_int p_int)
  {
    switch (p_int) {
      case 0:
        return hour::h00;
  ...
  inline operator amount<hour>() const { return amount<hour>(m_value); }

  static inline amount<minute> minutes() { return amount<minute>(60); }
