...
timestamp<second>::timestamp(year p_year,
                             month p_month,
                             day p_day,
                             hour p_hour,
                             minute p_minute,
...
timestamp<second>&
timestamp<second>::operator=(const timestamp& p_timestamp)
{
  if (this != &p_timestamp) {
...
timestamp<second>&
timestamp<second>::operator=(timestamp&& p_timestamp)
{
  if (this != &p_timestamp) {
...
timestamp<second>&
timestamp<second>::operator+=(amount<second> p_seconds)
{
...
timestamp<second>&
timestamp<second>::operator+=(amount<minute> p_minutes)
{
...
timestamp<second>&
timestamp<second>::operator+=(amount<day> p_days)
{
...
timestamp<second>&
timestamp<second>::operator+=(amount<weekday> p_weeks)
{
...
timestamp<second>&
timestamp<second>::operator+=(amount<month> p_months)
{
...
timestamp<second>
timestamp<second>::operator+=(amount<year> p_years)
{
