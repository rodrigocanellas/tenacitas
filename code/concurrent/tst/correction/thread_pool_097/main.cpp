  ...
  bool operator()() {
...

    {
      ...
      sleeping_loop _loop(
          ...
          [&_pool, &_value, &_counter]() -> concurrent::bus::work_status {
            ++_value;
            ++_counter;
            _pool.handle(_value);
            return concurrent::bus::work_status::dont_stop;
      ...
      _pool.add_work(
          [&_work_1](int32_t &&p_val) -> concurrent::bus::work_status {
            return _work_1(std::move(p_val));
          },
          std::chrono::milliseconds(200));
      _pool.add_work(
          [&_work_2](int32_t &&p_val) -> concurrent::bus::work_status {
...
int main(int argc, char **argv) {
  ...
  tester::bus::test::run<thread_pool_097>(argc, argv);
}
