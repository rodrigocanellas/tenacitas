...
struct async_loop_005
{
  bool operator()()
  {
    ...
    try {
      ...
      // ‘tenacitas::concurrent::business::business::async_loop<t_timeout,
      // t_data>::async_loop(tenacitas::concurrent::business::business::async_loop<t_timeout,
      ...
      // deleted function
      // ‘tenacitas::concurrent::business::business::async_loop<t_work_ptr, t_time,
      ...
      // deleted function
      // ‘tenacitas::concurrent::business::business::async_loop<t_work_ptr, t_time,
      // t_provide_ptr>::async_loop(tenacitas::concurrent::business::business::async_loop<t_work_ptr,
      ...
      // t_provide_ptr>&
      // tenacitas::concurrent::business::business::async_loop<t_work_ptr, t_time,
      // t_provide_ptr>::operator=(tenacitas::concurrent::business::business::async_loop<t_work_ptr,
      // t_time, t_provide_ptr>&&) [with t_work_ptr =
      // std::shared_ptr<work1>; t_time = std::chrono::duration<long int,
      // std::ratio<1, 1000> >; t_provide_ptr =
      // std::shared_ptr<provide>]’"
