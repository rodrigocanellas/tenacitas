...
struct thread_pool_097
{
  bool operator()()
  {
...

    {
      ...
      concurrent_log_test(logger::business::log, "counter = ", _counter);

      _pool.run();
    }
    concurrent_log_test(logger::business::log, "work 1 counter = ", _work_1.counter);
    concurrent_log_test(logger::business::log, "work 2 counter = ", _work_2.counter);
