...
struct dispatcher_000
{
  ...
  bool operator()()
  {
    ...
    dispatcher_t<msg_a, log>::subscribe("a2", subscriber_2(), _work_timeout);
    dispatcher_t<msg_a, log>::subscribe("a3", subscriber_4(), _work_timeout);
    dispatcher_t<msg_b, log>::subscribe("b1", subscriber_2(), _work_timeout);
    dispatcher_t<msg_b, log>::subscribe("b2", subscriber_3(), _work_timeout);
    dispatcher_t<msg_b, log>::subscribe("b3", subscriber_4(), _work_timeout);
    dispatcher_t<msg_c, log>::subscribe("c1", subscriber_4(), _work_timeout);
