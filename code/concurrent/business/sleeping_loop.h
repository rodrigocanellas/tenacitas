#ifndef TENACITAS_CONCURRENT_BUSINESS_SLEEPING_LOOP_H
#define TENACITAS_CONCURRENT_BUSINESS_SLEEPING_LOOP_H
...
struct sleeping_loop_t
{
  ...
  sleeping_loop_t(std::chrono::milliseconds p_interval,
    ...
    : m_async(std::move(p_work),
              std::move(p_timeout),
              [this]() -> work_status { return this->break_loop(); },
              std::move(p_provide))
