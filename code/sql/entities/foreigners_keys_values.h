#ifndef CAPEMISA_TEST_AUTOMATION_ENTITIES_FOREIGNERS_KEYS_VALUES_H
#define CAPEMISA_TEST_AUTOMATION_ENTITIES_FOREIGNERS_KEYS_VALUES_H
...
struct foreigners_keys_values {
  ...
  const_iterator add(const foreign_key_name & p_foreign_key_name
    ...
    m_list.push_back(foreign_key_value(p_foreign_key_name
