...
struct create_abstract_model
{
  ptr<hosts> operator()()
  {
    ...
    ptr<table> _c = _db->add_table("C");
    {
      ...
      _c->add_attribute("c1", column::type::small_real, false, false);
      _c->add_attribute("c2", column::type::var_size_text, 100, false, false);
    }
    ...
    ptr<table> _b = _db->add_table("B");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _b->add_attribute("b1", column::type::small_real, false, false);
      _b->add_attribute("b2", column::type::var_size_text, 100, false, false);
    ...
    ptr<table> _f = _db->add_table("F");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _f->add_attribute("f1", column::type::small_real, false, false);
    ...
    ptr<table> _h = _db->add_table("H");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _h->add_attribute("h1", column::type::small_real, false, false);
    }
    ...
    ptr<table> _j = _db->add_table("J");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _j->add_attribute("j1", column::type::small_real, false, false);
    }
    ...
    ptr<table> _e = _db->add_table("E");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _e->add_attribute("e1", column::type::small_real, false, false);
    ...
    ptr<table> _g = _db->add_table("G");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _e->add_attribute("g1", column::type::small_real, false, false);
    }
    ...
    ptr<table> _d = _db->add_table("D");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _d->add_attribute("d1", column::type::small_real, false, false);
    ...
    ptr<table> _a = _db->add_table("A");
    {
      ...
      _pk->add_pk_column("id", column::type::int_4, false, true);
      _a->add_attribute("a1", column::type::small_real, false, false);
