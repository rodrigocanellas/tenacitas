...
using device_id = tenacitas::lib::sof::id;
...
struct generator {
  generator() = default;
  generator(tenacitas::lib::sof::id p_id, amount p_generated, time p_interval)
...
using subscribers_results = std::map<tenacitas::lib::sof::id, total>;
