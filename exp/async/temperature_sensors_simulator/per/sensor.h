...
template <src::src::traits::log::logger t_logger,
          src::traits::async::dispatcher t_dispatcher>
requires(

    src::traits::async::dispatcher<t_dispatcher, evt::new_temperature>

        &&

            src::traits::async::has_const_lvalue_publish_method<
                t_dispatcher, src::async::result, evt::new_temperature>

                &&

                    src::traits::async::has_variadic_params_publish_method<
                        t_dispatcher, src::async::result, evt::new_temperature>
