...
template <event_id t_event_id, handler_type_id t_type_id,
          src::traits::async::dispatcher<async::event_handled> t_dispatcher>
struct handler {
  ...
  handler(logger &p_logger, t_dispatcher &p_dispatcher,
          src::async::handling_id p_handling_id,
...
private:
  ...
  src::async::handling_id m_handling_id;
