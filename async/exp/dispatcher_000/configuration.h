...
#ifndef TENACITAS_LIB_ASYNC_EXP_DISPATCHER_CONFIGURATION_H
#define TENACITAS_LIB_ASYNC_EXP_DISPATCHER_CONFIGURATION_H
...
private:
  using ini_file = parser::ini_file<t_logger>;
