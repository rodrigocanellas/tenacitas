...
#ifndef TENACITAS_LIB_TEST_FORMAT_FORMAT_NUMBER_H
#define TENACITAS_LIB_TEST_FORMAT_FORMAT_NUMBER_H
...
struct format_number_006 {
  ...
  bool operator()(const program::options &) {
    // const std::string _str(format::format_number<std::string>("-3"),'0');
    return true;
  }
};
