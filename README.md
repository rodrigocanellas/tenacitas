...
# This repository hosts these C++ projects: #

    calendar - classes to support time manipulation and conversion.
    ...
    program - Classes related to programs, such as program options.
